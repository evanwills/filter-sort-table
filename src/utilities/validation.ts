...
export const invalidString = (prop: string, input: IObjScalarX, notEmpty: boolean): string | false => {
  ...
  if (!isStr(prop)) {
    throw new Error(
      'invalidString() expects first parameter "prop" to be a ' +
  ...
  if (typeof input !== 'object') {
    throw new Error(
      'invalidString() expects second parameter "input" to be a ' +
...
export const invalidStrNum = (prop: string, input: IObjScalarX): string | false => {
  ...
  if (typeof prop !== 'string') {
    throw new Error(
      'invalidStrNum() expects first parameter "prop" to be a ' +
      'string matching the name of a property in the object. ' +
      typeof prop + ' given.');
  }
  if (typeof input !== 'object') {
    throw new Error(
      'invalidStrNum() expects second parameter "input" to be a ' +
      'an object containing "' + prop + '" property. ' +
      typeof input + ' given.'
    );
  }
...
export const invalidNum = (prop: string, input: IObjScalarX): string | false => {
  ...
  if (typeof prop !== 'string') {
    throw new Error(
      'invalidNum() expects first parameter "prop" to be a string ' +
      'matching the name of a property in the object. ' +
      typeof prop + ' given.'
    );
  }
  if (typeof input !== 'object') {
    throw new Error(
      'invalidNum() expects second parameter "input" to be a an '+
      'object containing "' + prop + '" property. ' + typeof input +
      ' given.'
    );
  }
...
export const invalidArray = (prop: string, input: IObjScalarX, notEmpty: boolean): string | false => {
  ...
  if (typeof prop !== 'string') {
    throw new Error(
      'invalidArray() expects first parameter "prop" to be a ' +
      'string matching the name of a property in the object. ' +
      typeof prop + ' given.');
  }
  if (typeof input !== 'object') {
    throw new Error(
      'invalidArray() expects second parameter "input" to be a an ' +
      'object containing "' + prop + '" property. ' + typeof input +
      ' given.'
    );
  }
...
export const validateIsoDate = (
  input: string,
  _default: string | false = false,
  _modifiers: valDateTimeMods = {}
): string | false => {
...
/**
 * Get the number of seconds for a unit of time.
 *
 * @param str Name of unit
 *
 * @returns The number of seconds for that time unit
 */
...
/**
 * Convert a duration string into milliseconds seconds
 *
 * @param duration Duration string
 *
 * @returns Number of milliseconds the duration string represents
 */
export const _strToMilliseconds = (duration: string): number => {
  const _duration = duration.toLocaleLowerCase().trim().replace(/\s+/g, ' ');
  ...
  while ((matches = _regex.exec(_duration)) !== null) {
    if (_sign === 0) {
